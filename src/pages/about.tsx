      ...
      <div>
        <div className='container mx-auto'>
          <main className='mt-12 flex h-full w-full flex-col items-center'>
            ...
            <p className='mt-2 text-sm text-gray-800'>
              Our culture thrives, not in any document, but in the experiences
              of our team. Creating Innodigi is a celebration of digies, past
              and present. Let us take you on a journey across Innodigiland.
            </p>
            ...
            <p className='mt-2 text-sm text-gray-800'>
              Our technical expertise, broad solutions portfolio and supply
              chain capabilities give us the right resources and scale to
              achieve more for you.
            </p>
